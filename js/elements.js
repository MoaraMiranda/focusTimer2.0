...
const buttonNatureSound = document.querySelector(".nature");
const buttonRainSound = document.querySelector(".rain");
const buttonCafeSound = document.querySelector(".cafeteria");
const buttonFireplaceSound = document.querySelector(".fireplace");
const natureIcon = document.querySelector("#nature-button");
